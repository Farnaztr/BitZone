...
**BitZone** is a production-grade, cyberpunk-inspired career guidance platform engineered entirely with **Pure Vanilla JavaScript**.  
This project demonstrates advanced frontend engineering skills including **state persistence across multi-page navigation**, **high-performance graphics rendering**, and **immersive UX design**, without relying on any external frameworks or libraries.
...
      <img src="https://github.com/user-attachments/assets/960eab30-67ad-4b35-83cf-2009e0bdd0e7" alt="Hero Section" style="width: 100%; border-radius: 8px;">
    </td>
    <td style="width: 50%; padding: 5px;">
      <img src="https://github.com/user-attachments/assets/ad2e5a04-9a79-4eb6-83a6-fe5ff9d41231" alt="Roadmap View" style="width: 100%; border-radius: 8px;">
    </td>
  </tr>
  <tr>
    <td style="width: 50%; padding: 5px;">
      <img src="https://github.com/user-attachments/assets/4e62a150-6e86-422d-aa0c-ea96241949db" alt="Learning Path" style="width: 100%; border-radius: 8px;">
    </td>
    <td style="width: 50%; padding: 5px;">
      <img src="https://github.com/user-attachments/assets/c2ca8417-5796-47be-a082-5529d9c703d7" alt="Auth System" style="width: 100%; border-radius: 8px;">
    </td>
  </tr>
  <tr>
    <td style="width: 50%; padding: 5px;">
      <img src="https://github.com/user-attachments/assets/1d9213ef-19d2-45c8-a90b-4051fe6b161a" alt="User Dashboard" style="width: 100%; border-radius: 8px;">
    </td>
    <td style="width: 50%; padding: 5px;">
      <img src="https://github.com/user-attachments/assets/1b8e392b-5f9f-4620-924c-1b15165d2541" alt="Mobile Experience" style="width: 100%; border-radius: 8px;">
    </td>
  </tr>
</table>
...
In standard Multi-Page Applications, navigation resets application state.  
BitZone solves this with a **custom audio persistence layer**:
...
<p align="center">
  <b>Designed & Engineered by Farnaz</b><br/>
</p>
